...
U32 ADVCMNAPI Acm_AxMoveAbs_T(HAND AxisHandle, F64 Distance, F64 Time, F64 Factor); //ydd 16.4.21.For luyuan.
U32 ADVCMNAPI Acm_AxMoveAbs_SD(HAND AxisHandle, F64 Distance, F64 SDDistance); //Andy 17.01.17.For Allring.
...
U32 ADVCMNAPI Acm_DaqCntSetCmpData(HAND DeviceHandle, U16 CntChannel, I32 CmpData);
...
U32 ADVCMNAPI Acm_DaqCntGetCounterDataEx(HAND DeviceHandle, U16 RingNo, U16 SlaveIP, U16 CntChannel, PI32 CounterData);
U32 ADVCMNAPI Acm_DaqCntGetLatchDataEx(HAND DeviceHandle, U16 RingNo, U16 SlaveIP, U16 CntChannel, PI32 LatchData);
U32 ADVCMNAPI Acm_DaqCntGetCmpDataEx(HAND DeviceHandle, U16 RingNo, U16 SlaveIP, U16 CntChannel, PI32 CmpData);
U32 ADVCMNAPI Acm_DaqCntSetCmpDataEx(HAND DeviceHandle, U16 RingNo, U16 SlaveIP, U16 CntChannel, I32 CmpData);
...
U32 ADVCMNAPI Acm_Dev2DCompensateTable (HAND DeviceHandle, HAND AxisHandle, HAND RelAxisHandle, F32 OriginPosX, F32 OriginPosY, F32 PitchX, F32 PitchY, PF32 OffsetDataX, PF32 OffsetDataY, U32 ArrayElementsX, U32 ArrayElementsY);
U32 ADVCMNAPI Acm_AxGetCompensatePosition(HAND AxisHandle, PF64 Position);

U32 ADVCMNAPI Acm_DevMultiTrigInitial(HAND DeviceHandle, IN U16 RingNo, IN U16 SlaveIP, IN U16 Enable, IN U8 PWM);
#ifdef __cplusplus
}
#endif
